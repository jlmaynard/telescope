...
#
# Written by Olivia and Jason Maynard 2015
#
# Input: There are 2 separate input files required. "tele_input.txt" for
# telescope input. Multiple telescopes are allowed. Each telescope has a
# name, aperature (in), and length (mm). "eye_input.txt" allows for multiple
# eyepieces each with a name, apparant field of view, and focal length (mm).
#
...
class Telescope:
    ...
    def get_resolution(self):
        """
        This function will return the resolution of the telescope, which is
        the smallest angle in arc seconds the
        telescope can see.
        :return:
        """
    ...
    def get_longest_useful_eyepiece(self):
        ...
        :return:
        """
        return 6.0 * self.get_focal_ratio()
    ...
    def get_max_mag(self):
        """
        This function returns the maximum useful magnification. The theoretical
        limit for useful magnification is 50 to
    ...
    def get_min_mag(self):
        ...
        http://www.garyseronik.com/?q=node/117
        :return:
        """
        return self.aperture / 6.0
...
# We now have a list of eyepiece objects
